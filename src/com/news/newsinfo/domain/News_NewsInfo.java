...
public String toString() {
	return "News_NewsInfo [NI_Id=" + NI_Id + ", NI_ContentId=" + NI_ContentId + ", NI_Title=" + NI_Title
			...
			+ NI_BelongNavigation + ", NI_BrowserCount=" + NI_BrowserCount + ", NI_Source=" + NI_Source + ", NI_Author="
			+ NI_Author + ", NI_Content=" + NI_Content + ", NI_IsDelete=" + NI_IsDelete + ", NI_IsShow=" + NI_IsShow
			+ ", NI_ShowTime=" + NI_ShowTime + ", NI_CreateTime=" + NI_CreateTime + ", NI_ModifyTime=" + NI_ModifyTime
			+ ", NI_IsRecommend=" + NI_IsRecommend + "]";
}
